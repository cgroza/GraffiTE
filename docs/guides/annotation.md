...
!!! important "`--human` replaces the trusted subset"
    ...
    <span class="src">`module/main.nf:590-601`</span>
...
<span class="src">`module/main.nf:654`, `module/main.nf:572`, `nextflow.config:56`</span>
...
<span class="src">`module/main.nf:658-702`, `nextflow.config:49`</span>
...
fixed in the script.
<span class="src">`bin/add_polyA.py:21-23,100-133`, `module/main.nf:582`</span>
...
<span class="src">`module/main.nf:13-15,20-23,593`</span>
...
!!! warning "The negated class test is weaker than it looks"
    ...
    <span class="src">`module/main.nf:538-542`</span>
...
- **By contig.** `split_repeatmask` writes one VCF per contig of the merged set and
  ...
  <span class="src">`module/main.nf:487-500`, `nextflow.config:222-226`</span>
